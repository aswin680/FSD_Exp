...
function te(e, t, n) {
  if (void 0 === n && (n = false), !n && !ee(e) && !Array.isArray(e))
    return t;
  if (Array.isArray(t))
  ...
  return e.prototype.indexOfGroup = function(e2) {
    ...
    if (e2 >= this.groupSizes.length) {
      for (var n = this.groupSizes, o2 = n.length, r2 = o2; e2 >= r2; )
        if ((r2 <<= 1) < 0)
          throw se(16, "".concat(e2));
      this.groupSizes = new Uint32Array(r2), this.groupSizes.set(n), this.length = r2;
      for (var s = o2; s < r2; s++)
        this.groupSizes[s] = 0;
    }
    for (var i = this.indexOfGroup(e2 + 1), a2 = (s = 0, t.length); s < a2; s++)
    ...
    for (var n = this.groupSizes[e2], o2 = this.indexOfGroup(e2), r2 = o2 + n, s = o2; s < r2; s++)
      t += "".concat(this.tag.getRule(s)).concat(d);
    return t;
  }, e;
}();
var ae = 1 << 30;
    ...
    this.options = __assign(__assign({}, Ce), e2), this.gs = n, this.names = new Map(o2), this.server = !!e2.isServer, !this.server && p && Ne && (Ne = false, ve(this)), ne(this, function() {
      return function(e3) {
        for (var t = e3.getTag(), n2 = t.length, o3 = "", r3 = function(n3) {
          ...
          if (void 0 === s2 || !s2.size || 0 === i.length)
            return "continue";
...
function Ie(e) {
  ...
  for (var t = e.length, n = 0, o2 = 0, r2 = false, s = 0; s < t; s++) {
    ...
    if (0 !== o2 || r2 || i !== _e || 42 !== e.charCodeAt(s + 1))
      if (r2)
        42 === i && e.charCodeAt(s + 1) === _e && (r2 = false, s++);
  ...
  var p2 = function(e2, r3, i2, c3) {
    ...
    var u3 = function(e3) {
      ...
      for (var t2 = e3.length, n2 = "", o3 = 0, r4 = 0, s = 0, i3 = false, a3 = 0; a3 < t2; a3++) {
        ...
        if (0 !== s || i3 || c4 !== _e || 42 !== e3.charCodeAt(a3 + 1))
          if (i3)
            42 === c4 && e3.charCodeAt(a3 + 1) === _e && (i3 = false, a3++);
      ...
      for (var t2 = e3.length, n2 = [], o3 = 0, r4 = 0, s = 0, i3 = 0; r4 < t2; ) {
        ...
        if (34 !== a3 && 39 !== a3 || 0 !== r4 && 92 === e3.charCodeAt(r4 - 1))
          if (0 === s)
            if (40 === a3 && r4 >= 3 && 108 == (32 | e3.charCodeAt(r4 - 1)) && 114 == (32 | e3.charCodeAt(r4 - 2)) && 117 == (32 | e3.charCodeAt(r4 - 3)))
              i3 = 1, r4++;
            else if (i3 > 0)
              41 === a3 ? i3-- : 40 === a3 && i3++, r4++;
...
function qe(e, t, n, o2) {
  ...
  if (X(e)) {
    if (!X(s = e) || s.prototype && s.prototype.isReactComponent || !t)
      return [e];
    var r2 = e(t);
...
function tt(e, s, i) {
    ...
    return function(e3, s3, i2) {
      ...
      var v3 = b(s3, f3, u3) || w, g2 = function(e4, n, o2) {
        for (var r2, s4 = __assign(__assign({}, n), { className: void 0, theme: o2 }), i3 = 0; i3 < e4.length; i3 += 1) {
          ...
          for (var c4 in a4)
            "className" === c4 ? s4.className = K(s4.className, a4[c4]) : "style" === c4 ? s4.style = __assign(__assign({}, s4.style), a4[c4]) : s4[c4] = a4[c4];
        }
        return "className" in n && "string" == typeof n.className && (s4.className = K(s4.className, n.className)), s4;
      }(a3, s3, v3), S2 = g2.as || p3, N3 = {};
      for (var C3 in g2)
        void 0 === g2[C3] || "$" === C3[0] || "as" === C3 || "theme" === C3 && g2.theme === v3 || ("forwardedAs" === C3 ? N3.as = g2.forwardedAs : y3 && !y3(C3, S2) || (N3[C3] = g2[C3], y3 || false || isPropValid(C3) || et.has(C3) || !E.has(S2) || (et.add(C3), console.warn('styled-components: it looks like an unknown prop "'.concat(C3, '" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)')))));
  ...
  } }), g(v2, N2), T2.warnTooManyClasses = function(e2, t) {
    var n = {}, o2 = false;
    return function(r2) {
